...
def save_character(character_data):
    ...
    if 'class_equipment' in character_data:
        if 'options' in character_data['class_equipment']:
    ...
    # Clean up class features
    if 'class_features' in character_data:
        for feature_name in list(character_data['class_features'].keys()):
            if 'choices' in character_data['class_features'][feature_name]:
                del character_data['class_features'][feature_name]['choices']
