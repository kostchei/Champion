...
new_suffixes = ["Dancing", "Defender", "Frost brand", "Nine Lives Stealer", "Dragon Slayer", "Giant Slayer", "Vicious"]
existing_names = ["Scimitar", "Rapier", "Shortsword", "Longsword", "Greatsword"]
